...
public interface INode<T extends Comparable<T>> {
	 ...
	 * 
	 * @return eg.edu.alexu.csd.filestructure.sort.INode wrapper to the left child
	 ...
	 * 
	 * @return eg.edu.alexu.csd.filestructure.sort.INode wrapper to the right child
	 *         of the current element/node
	 */
	 ...
	 * 
	 * @return eg.edu.alexu.csd.filestructure.sort.INode wrapper to the parent of
